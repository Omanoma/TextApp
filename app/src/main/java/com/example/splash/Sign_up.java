...
public class Sign_up extends AppCompatActivity {
    ...
    public void ValidateOrAdd(View v){
        ...
        if(!a.checkUser()) Toast.makeText(Sign_up.this,"User Not correct",Toast.LENGTH_LONG);
        else if(!a.checkEmail())  Toast.makeText(Sign_up.this,"Email Not correct",Toast.LENGTH_LONG);
        else if(!a.SamePass(rp)) Toast.makeText(Sign_up.this,"Password Not correct",Toast.LENGTH_LONG);
